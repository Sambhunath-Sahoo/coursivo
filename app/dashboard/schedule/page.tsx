...
export default function SchedulePage() {
  ...
  const upcomingThisWeek = upcomingLessons.filter(
    (lesson) => {
  ...
  return (
    <DashboardLayout type="student">
      <div className="flex-1 overflow-auto">
        ...
        {/* Today's Lessons */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Today's Lessons</h2>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-sm text-gray-600">{lesson.time} • {lesson.duration}</p>
                        {getLessonTypeBadge(lesson.type)}
                      </div>
                    </div>
                  </CardContent>
