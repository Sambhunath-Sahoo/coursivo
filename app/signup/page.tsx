...
export default function SignupPage() {
  ...
  useEffect(() => {
      console.log("TCL: SignupPage -> session", session)
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="max-w-md w-full space-y-8 p-6">
        <div>
          <h2 className="text-center text-3xl font-bold">Sign up for {tenant} Academy</h2>
        </div>
        ...
        <div className="text-center">
          <a href={`/signin?tenant=${tenant}`} className="text-blue-600">
